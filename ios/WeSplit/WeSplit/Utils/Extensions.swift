...
extension Color {
    ...
    static let tabBarBrder = Color("Tab Bar Border").opacity(0.5)
    static let forecastCardBckground = Color("Forecast Card Background")
    static let probabilityTxt = Color("Probability Text")
}
